...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of stai', () => {
      const result = units.getUnit('stai');
    ...
    it('gets unit of stai using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of stai', () => {
      const result = units.getDisplay('stai');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('stai', 9);

      const result = units.getUnit('stai');

      expect(result).toEqual(9);

      units.setUnit('stai', 1);
    });
  });
  describe('#setDisplay', () => {

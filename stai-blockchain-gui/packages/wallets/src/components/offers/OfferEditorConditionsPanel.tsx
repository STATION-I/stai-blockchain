...
import { useGetWalletBalanceQuery, useGetWalletsQuery } from '@stai/api-react';
import { Wallet, WalletType } from '@stai/api';
    ...
    if (!isLoading && tradeSide === 'sell' && walletBalance && walletBalance.walletId == row.assetWalletId) {
      switch (item.walletType) {
        case WalletType.STANDARD_WALLET:
          balanceString = mojoToStaiLocaleString(walletBalance.spendableBalance);
          balance = mojoToStai(walletBalance.spendableBalance);
          break;
        case WalletType.CAT:

...
import { Button, CopyToClipboard, Card, Loading, Flex, TooltipIcon } from '@stai/core';
import { useGetCurrentAddressQuery, useGetNextAddressMutation } from '@stai/api-react';
import {
  Box,
  TextField,
  InputAdornment,

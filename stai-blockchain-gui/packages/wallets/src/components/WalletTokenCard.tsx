...
import { useSetCATNameMutation } from '@stai/api-react';
...
import { Tooltip, CardListItem, Flex, Link, useShowError } from '@stai/core';
...
export default function WalletTokenCard(props: WalletTokenCardProps) {
  ...
  const currentName = walletType === WalletType.STANDARD_WALLET ? 'STAI' : name;

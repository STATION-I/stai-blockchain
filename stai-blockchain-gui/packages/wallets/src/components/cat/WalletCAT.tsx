...
import { Flex, Loading, useOpenDialog } from '@stai/core';
...
import { useSetCATNameMutation, useGetCatListQuery } from '@stai/api-react';
import { Offers as OffersIcon } from '@stai/icons';

...
import { Flex, UnitFormat, More, Table, mojoToStaiLocaleString, Suspender } from '@stai/core';
...
import { WalletStatus } from '@stai/wallets';
  ...
  },
  {
    field: (nft: PlotNFT) => {
      ...
      if (state === PlotNFTStateEnum.SELF_POOLING) {
        return (
          <UnitFormat
            value={mojoToStaiLocaleString(nft.walletBalance.confirmedWalletBalance ?? 0)}
          />
        );
      }

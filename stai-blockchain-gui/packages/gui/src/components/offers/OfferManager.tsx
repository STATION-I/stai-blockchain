...
function ConfirmOfferCancellation(props: ConfirmOfferCancellationProps) {
  ...
  async function handleConfirm() {
    ...
    const fee = cancelWithTransaction ? staiToMojo(staiFee) : new BigNumber(0);
...
function OfferList(props: OfferListProps) {
  ...
  const testnet = useCurrencyCode() === 'TSTAI';
        ...
        <Grid container>
          <Grid xs={12} md={6} lg={5} item>
            <CardHero>
              ...
              <Typography variant="body1">
                <Trans>
                  Create an offer to exchange assets including STAI, tokens, and

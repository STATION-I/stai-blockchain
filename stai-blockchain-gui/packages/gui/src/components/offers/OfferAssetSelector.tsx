...
import { Wallet, WalletType, type CATToken } from '@stai/api';
import { useGetCatListQuery, useGetWalletsQuery } from '@stai/api-react';
import { Trans } from '@lingui/macro';
import { FormControl, InputLabel, MenuItem } from '@mui/material';
import { Select, useCurrencyCode } from '@stai/core';

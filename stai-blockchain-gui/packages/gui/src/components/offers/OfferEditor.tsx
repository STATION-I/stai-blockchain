...
import { useCreateOfferForIdsMutation } from '@stai/api-react';
...
import { staiToMojo, catToMojo } from '@stai/core';
...
function OfferEditor(props: OfferEditorProps) {
  ...
  async function onSubmit(formData: FormData) {
    ...
    let feeInMojos = staiToMojo(formData.fee ?? 0);

...
import icon from '../../assets/img/stai_circle.svg';
  ...
  return (
    <html>
      ...
      <body>
        ...
        <Spacer />
        <div className="copyright">Copyright (c) {currentYear} Chia Network, STAI GmbH</div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
            <tr>
        ...
        <BugReport
          href="https://github.com/STATION-I/stai-blockchain/issues"
          target="_blank"
        >
          Report an issue
        </BugReport>

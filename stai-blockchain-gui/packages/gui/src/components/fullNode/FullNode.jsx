...
import { Status } from '@stai/icons';
import { useGetLatestBlocksQuery, useGetUnfinishedBlockHeadersQuery } from '@stai/api-react';
...
import FullNodeSyncSpeedHeader from './FullNodeSyncSpeedHeader';

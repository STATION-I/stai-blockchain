...
import { defaultPlotter } from '@stai/api';
import { useStartPlottingMutation, useCreateNewPoolWalletMutation } from '@stai/api-react';
import { ChevronRight as ChevronRightIcon } from '@material-ui/icons';
import { useForm, SubmitHandler } from 'react-hook-form';
import { useShowError, ButtonLoading, Flex, Form, FormBackButton, toBech32m } from '@stai/core';
...
export default function PlotAddForm(props: Props) {
  ...
  const methods = useForm<FormData>({
    defaultValues: defaultsForPlotter(PlotterName.STAIPOS),
  });

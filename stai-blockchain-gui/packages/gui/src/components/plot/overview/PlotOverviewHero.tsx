...
import { useRefreshPlotsMutation } from '@stai/api-react';
import { Button, Grid, Typography, Divider } from '@material-ui/core';
import { CardHero, Flex, Link, useOpenDialog } from '@stai/core';
import { PlotHero as PlotHeroIcon } from '@stai/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Stai. '
              }
              <Link
                target="_blank"

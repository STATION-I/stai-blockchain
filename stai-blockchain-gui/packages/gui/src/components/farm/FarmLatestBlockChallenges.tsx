...
import { useGetSignagePointsQuery, useGetCombinedPlotsQuery } from '@stai/api-react';
  ...
  return (
    ...
    >
      ...
      <Typography variant="caption">
        <Trans>
          *Want to explore Stai’s blocks further? Check out{' '}
          <Link
            color="primary"
            href="https://www.staiexplorer.org/"
            target="_blank"
          >
            Stai Explorer
          </Link>{' '}

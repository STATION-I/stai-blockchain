...
import AppIcon from '../assets/img/stai64x64.png';
    ...
    const template = [
      ...
      },
      {
        ...
        submenu: [
          ...
          {
            label: i18n._(/* i18n */ { id: 'Quick Start Guide' }),
            click: () => {
              openExternal(
          ...
          {
            label: i18n._(/* i18n */ { id: 'Report an issue on GitHub' }),
            click: () => {
              openExternal(
                'https://github.com/STATION-I/stai-blockchain/issues',
              );
            },
          },
          {
          ...
          },
          {
            ...
            click: () => {
              openExternal('https://discord.gg/stai-blockchain');
            },
          },
          {

...
import staiToMojo from '../../utils/staiToMojo';
...
export default function Amount(props: AmountProps) {
  ...
  const isStaiCurrency = ['STAI', 'TSTAI'].includes(currencyCode);
  const mojo = isStaiCurrency 
    ? staiToMojo(correctedValue) 
    ...
    <FormControl variant={variant} fullWidth={fullWidth}>
      <TextField
        ...
        InputProps={{
          ...
          inputProps: {
            decimalScale: isStaiCurrency ? 12 : 3,
          },
          endAdornment: (

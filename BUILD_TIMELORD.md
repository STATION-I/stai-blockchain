...
required to run a [Timelord](https://github.com/pinksheetscrypto/staicoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/pinksheetscrypto/staicoin-blockchain/blob/main/install-timelord.sh)

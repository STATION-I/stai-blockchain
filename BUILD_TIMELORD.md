...
required to run a [Timelord](https://github.com/STATION-I/staicoin-blockchain/wiki/Timelords).
...
[install-timelord.sh](https://github.com/STATION-I/staicoin-blockchain/blob/main/install-timelord.sh)

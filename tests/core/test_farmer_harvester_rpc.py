...
from staicoin.plotting.plot_tools import stream_plot_info_ph, stream_plot_info_pk
from staicoin.protocols import farmer_protocol
from staicoin.rpc.farmer_rpc_api import FarmerRpcApi
from staicoin.rpc.farmer_rpc_client import FarmerRpcClient
from staicoin.rpc.harvester_rpc_api import HarvesterRpcApi
from staicoin.rpc.harvester_rpc_client import HarvesterRpcClient
...
from staicoin.wallet.derive_keys import master_sk_to_wallet_sk, master_sk_to_pooling_authentication_sk
...
class TestRpc:
    ...
    async def test1(self, simulation):
        ...
        try:
            ...
            await client.set_reward_targets(encode_puzzle_hash(new_ph, "stai"), encode_puzzle_hash(new_ph_2, "stai"))
            ...
            await client.set_reward_targets(None, encode_puzzle_hash(new_ph_3, "stai"))
            ...
            assert config["farmer"]["stai_target_address"] == encode_puzzle_hash(new_ph, "stai")
            assert config["pool"]["stai_target_address"] == encode_puzzle_hash(new_ph_3, "stai")

            new_ph_3_encoded = encode_puzzle_hash(new_ph_3, "stai")

...
from staicoin.pools.pool_config import PoolWalletConfig
from staicoin.util.config import load_config, save_config, create_default_staicoin_config
...
def test_pool_config():
    ...
    create_default_staicoin_config(test_root, ["config.yaml"])

...
from staicoin.daemon.server import WebSocketServer, create_server_for_daemon, daemon_launch_lock_path, singleton
from staicoin.full_node.full_node_api import FullNodeAPI
from staicoin.server.start_farmer import service_kwargs_for_farmer
from staicoin.server.start_full_node import service_kwargs_for_full_node
from staicoin.server.start_harvester import service_kwargs_for_harvester
from staicoin.server.start_introducer import service_kwargs_for_introducer
from staicoin.server.start_service import Service
from staicoin.server.start_timelord import service_kwargs_for_timelord
from staicoin.server.start_wallet import service_kwargs_for_wallet
from staicoin.simulator.start_simulator import service_kwargs_for_full_node_simulator
from staicoin.timelord.timelord_launcher import kill_processes, spawn_process
...
async def setup_farmer(
    ...
    config["stai_target_address"] = encode_puzzle_hash(b_tools.farmer_ph, "stai")

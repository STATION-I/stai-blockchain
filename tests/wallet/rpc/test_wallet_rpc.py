...
class TestWalletRpc:
    ...
    async def test_wallet_make_transaction(self, two_wallet_nodes):
        ...
        try:
            addr = encode_puzzle_hash(await wallet_node_2.wallet_state_manager.main_wallet.get_new_puzzlehash(), "stai")
            tx_amount = 15600000
            try:
            ...
            for i in range(0, 5):
                await client.farm_block(encode_puzzle_hash(ph_2, "stai"))

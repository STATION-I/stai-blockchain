...
from stai.protocols import wallet_protocol, full_node_protocol
...
from stai.protocols.wallet_protocol import RespondToCoinUpdates, CoinStateUpdate, RespondToPhUpdates, CoinState

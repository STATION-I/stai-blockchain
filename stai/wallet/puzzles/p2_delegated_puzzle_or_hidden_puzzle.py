...
- The user's wallet contains a primary sk/pk pair which are used to derive to one
  ...
  https://stailisp.com/docs/standard_transaction. Therefore, when a wallet needs
...
- Python code previously appeared which was written like:
  ...
  In context, delegated_puzzle_solution here is any *stailisp program*, here one
  ...
  The second and third arguments are a stailisp program and its corresponding

...
from stai.pools.pool_puzzles import SINGLETON_LAUNCHER_HASH, solution_to_pool_state
from stai.pools.pool_wallet import PoolWallet
from stai.protocols import wallet_protocol
from stai.protocols.wallet_protocol import CoinState, PuzzleSolutionResponse, RespondPuzzleSolution
...
from stai.wallet.cat_wallet.cat_utils import construct_cat_puzzle, match_cat_puzzle
...
from stai.wallet.did_wallet.did_info import DID_HRP
from stai.wallet.did_wallet.did_wallet import DIDWallet
from stai.wallet.did_wallet.did_wallet_puzzles import DID_INNERPUZ_MOD, create_fullpuz, match_did_puzzle
from stai.wallet.key_val_store import KeyValStore
from stai.wallet.nft_wallet.nft_info import NFTWalletInfo
...
from stai.wallet.puzzles.cat_loader import CAT_MOD
from stai.wallet.rl_wallet.rl_wallet import RLWallet
from stai.wallet.settings.user_settings import UserSettings
from stai.wallet.trade_manager import TradeManager
from stai.wallet.transaction_record import TransactionRecord
from stai.wallet.util.compute_hints import compute_coin_hints
from stai.wallet.util.transaction_type import TransactionType
from stai.wallet.util.wallet_sync_utils import last_change_height_cs
...
from stai.wallet.wallet_action_store import WalletActionStore
...
from stai.wallet.wallet_sync_store import WalletSyncStore
...
class WalletStateManager:
    ...
    async def new_coin_state(
        self, coin_states: List[CoinState], peer: WSStaiConnection, fork_height: Optional[uint32]
    ) -> None:

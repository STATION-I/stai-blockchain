...
from stai.consensus.blockchain import Blockchain, ReceiveBlockResult
...
class FullNode:
    ...
    def set_server(self, server: StaiServer):
        ...
        if "dns_servers" in self.config:
            ...
            dns_servers.append("dns-introducer.stai-network.net")
        try:
    ...
    async def sync_from_fork_point(
        ...
        async def fetch_block_batches(batch_queue, peers_with_peak: List[ws.WSStaiConnection]):
            try:
        ...
        batch_queue: asyncio.Queue[Tuple[ws.WSStaiConnection, List[FullBlock]]] = asyncio.Queue(

...
from stai.pools.pool_config import load_pool_config, PoolWalletConfig, update_pool_config
...
from stai.util.bech32m import encode_puzzle_hash, decode_puzzle_hash
        ...
        try:
            ...
            while time.time() - start < 10:
                ...
                if len(tx.sent_to) > 0:
                    ...
                    print(f"Do stai wallet get_transaction -f {fingerprint} -tx 0x{tx_record.name} to get status")
                    return None
        except Exception as e:

...
from stai.util.config import get_config_lock, load_config, save_config, str2bool
    ...
    with get_config_lock(root_path, "config.yaml"):
        ...
        if testnet:
            if testnet == "true" or testnet == "t":
                ...
                testnet_port = "51999"
                testnet_introducer = "introducer-testnet10.stainetwork.org"
                testnet_dns_introducer = "dns-introducer-testnet10.stainetwork.org"
                bootstrap_peers = ["testnet10-node.stainetwork.org"]
                testnet = "testnet10"

...
from stai.util.keychain import Keychain, bytes_to_mnemonic, generate_mnemonic, mnemonic_to_seed, unlocks_keyring
...
def show_all_keys(show_mnemonic: bool, non_observer_derivation: bool):
    ...
    for sk, seed in private_keys:
        ...
        print(f"First wallet address{' (non-observer)' if non_observer_derivation else ' (observer)'}: {wallet_address}")

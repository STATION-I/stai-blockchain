...
rm -rf ../venv || true
rm -rf venv || true
rm -rf stai_blockchain.egg-info || true
rm -rf build_scripts/final_installer || true
rm -rf build_scripts/dist || true
rm -rf build_scripts/pyinstaller || true
rm -rf stai-blockchain-gui/build || true
rm -rf stai-blockchain-gui/daemon || true
rm -rf stai-blockchain-gui/node_modules || true
rm stai-blockchain-gui/temp.json || true
( cd "$PWD/stai-blockchain-gui" && git checkout HEAD -- package-lock.json ) || true
cd "$PWD" || true
...
npm uninstall -g @stai-network/notarize-cli || true

...
from staicoin.util.api_decorators import api_request
from staicoin.util.ints import uint8
...
class FullNodeSimulator(FullNodeAPI):
    ...
    async def farm_new_transaction_block(self, request: FarmNewBlockProtocol):
        async with self.full_node.blockchain.lock:
            ...
            self.log.info(self.full_node.constants.GENESIS_PRE_FARM_OFFICIALWALLETS_PUZZLE_HASH)
            current_blocks = await self.get_all_full_blocks()
            ...
            more = self.bt.get_consecutive_blocks(
                ...
                officialwallets_reward_puzzle_hash=self.full_node.constants.GENESIS_PRE_FARM_OFFICIALWALLETS_PUZZLE_HASH,

...
from staicoin.daemon.server import singleton, service_launch_lock_path
from staicoin.server.ssl_context import staicoin_ssl_ca_paths, private_ssl_ca_paths
...
class Service:
    def __init__(
        ...
        proctitle_name = f"staicoin_{service_name}"
        ...
        staicoin_ca_crt, staicoin_ca_key = staicoin_ssl_ca_paths(root_path, self.config)
        inbound_rlp = self.config.get("inbound_rate_limit_percent")
        outbound_rlp = self.config.get("outbound_rate_limit_percent")
        assert inbound_rlp and outbound_rlp
        self._server = staicoinServer(
            advertised_port,
            node,
            peer_api,
            node_type,
            ...
            (staicoin_ca_crt, staicoin_ca_key),
    ...
    async def wait_closed(self) -> None:
        ...
        self._log.info("Waiting for staicoinServer to be closed")

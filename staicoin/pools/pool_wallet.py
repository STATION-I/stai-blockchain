...
from staicoin.pools.pool_config import PoolWalletConfig, load_pool_config, update_pool_config
from staicoin.pools.pool_wallet_info import (
    PoolWalletInfo,
    PoolSingletonState,
    PoolState,
    FARMING_TO_POOL,
...
from staicoin.protocols.pool_protocol import POOL_PROTOCOL_VERSION
...
from staicoin.pools.pool_puzzles import (
...
class PoolWallet:
    ...
    async def create_new_pool_wallet_transaction(
        ...
        the same pooling puzzle. This puzzle is a `staicoin singleton` that is

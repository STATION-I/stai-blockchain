...
from staicoin.util.condition_tools import conditions_dict_for_solution
    ...
    try:
        ...
        for coinsol in trade_offer.coin_spends:
            ...
            if r:
                ...
                if "staicoin" in cc_discrepancies:
                    cc_discrepancies["staicoin"] = cc_discrepancies["staicoin"] + diff
                else:
                    cc_discrepancies["staicoin"] = diff

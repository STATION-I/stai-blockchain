...
from staicoin.protocols.wallet_protocol import RespondAdditions, RejectAdditionsRequest
...
from staicoin.util.ints import uint64, uint32, uint8
from staicoin.wallet.util.transaction_type import TransactionType

from staicoin.wallet.did_wallet.did_info import DIDInfo
...
from staicoin.wallet.did_wallet import did_wallet_puzzles

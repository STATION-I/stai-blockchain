...
from staicoin.harvester.harvester import Harvester
from staicoin.plotting.plot_tools import PlotInfo, parse_plot_info
from staicoin.protocols import harvester_protocol
from staicoin.protocols.farmer_protocol import FarmingInfo
from staicoin.protocols.harvester_protocol import Plot
...
from staicoin.util.ints import uint8, uint32, uint64
...
class HarvesterAPI:
    ...
    async def new_signage_point_harvester(
        self, new_challenge: harvester_protocol.NewSignagePointHarvester, peer: WSstaicoinConnection
    ):
        """

...
from staicoin.cmds.configure import configure_cmd
from staicoin.cmds.farm import farm_cmd
from staicoin.cmds.init import init_cmd
from staicoin.cmds.keys import keys_cmd
from staicoin.cmds.netspace import netspace_cmd
from staicoin.cmds.plots import plots_cmd
from staicoin.cmds.show import show_cmd
from staicoin.cmds.start import start_cmd
from staicoin.cmds.stop import stop_cmd
from staicoin.cmds.wallet import wallet_cmd
from staicoin.cmds.plotnft import plotnft_cmd
...
@click.group(
    help=f"\n  Manage staicoin blockchain infrastructure ({__version__})\n",
    epilog="Try 'staicoin start node', 'staicoin netspace -d 192', or 'staicoin show -s'",
...
@cli.command("version", short_help="Show staicoin version")
def version_cmd() -> None:
    print(__version__)


@cli.command("run_daemon", short_help="Runs staicoin daemon")
@click.pass_context
def run_daemon_cmd(ctx: click.Context) -> None:
    from staicoin.daemon.server import async_run_daemon
    import asyncio

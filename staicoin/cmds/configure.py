...
from staicoin.util.config import load_config, save_config, str2bool
...
def configure(
    ...
    if testnet is not None:
        if testnet == "true" or testnet == "t":
            ...
            testnet_port = "1999"
            testnet_introducer = "beta1_introducer.staicoin-network.net"
            testnet = "testnet7"
            ...
            mainnet_port = "1999"
            mainnet_introducer = "introducer.staicoin-network.net"
            net = "mainnet"
    ...
    if change_made:
        print("Restart any running staicoin services for changes to take effect")

...
from staicoin.cmds.units import units
...
from staicoin.util.network import is_localhost
...
async def summary(
    ...
    if amounts is not None:
        print(f"Total staicoin farmed: {amounts['farmed_amount'] / units['staicoin']}")
        print(f"User transaction fees: {amounts['fee_amount'] / units['staicoin']}")
        print(f"Block rewards: {(amounts['farmer_reward_amount'] + amounts['officialwallets_reward_amount'] + amounts['pool_reward_amount']) / units['staicoin']}")
    ...
    if amounts is None:
        if wallet_not_running:
            print("For details on farmed rewards and fees you should run 'staicoin start wallet' and 'staicoin wallet show'")
        elif wallet_not_ready:
            print("For details on farmed rewards and fees you should run 'staicoin wallet show'")
    else:
        print("Note: log into your key using 'staicoin wallet show' to see rewards for each key")

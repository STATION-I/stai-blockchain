...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of staicoin', () => {
      const result = units.getUnit('staicoin');
    ...
    it('gets unit of staicoin using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of staicoin', () => {
      const result = units.getDisplay('staicoin');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('staicoin', 9);

      const result = units.getUnit('staicoin');

      expect(result).toEqual(9);

      units.setUnit('staicoin', 1);
    });
  });
  describe('#setDisplay', () => {
